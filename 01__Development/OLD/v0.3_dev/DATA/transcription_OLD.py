...
class AudioRecorder:
    def __init__(self):
        ...
        self.audio_frames2 = []  # for storing frames from the "Stereo Mix" device

    def record_audio(self, device_index, filename):
        audio = pyaudio.PyAudio()
        stream = audio.open(format=pyaudio.paInt16, channels=1,  # Mono channel
                            rate=16000,  # Frame rate of 16000
                            input=True,
        ...
        with wave.open(filename, 'wb') as wf:
            ...
            wf.setframerate(16000)  # Frame rate of 16000
    ...
    def stop_recording(self, save_path):
        ...
        transcription_file = save_path.replace('.wav', '.txt')
