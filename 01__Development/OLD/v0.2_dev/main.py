...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Start.clicked.connect(lambda: self.recorder.start_recording(mic_index=[mic['index'] for mic in self.mics if mic['name'] == self.Mic][0], sys_sound_device=[mic['index'] for mic in self.mics if 'Stereo Mix' in mic['name']][0]))
